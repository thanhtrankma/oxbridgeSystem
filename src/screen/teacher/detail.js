  ...
  return (
    <SafeAreaView style={styles.containerWrapper}>
      ...
      <ScrollView>
        ...
        <View style={[styles.bigLabel, styles.borderBottom]}>
          <View>
            <Text style={styles.textBold}>{workingInformation}</Text>
          </View>
        </View>
        <View style={styles.container}>
          <View style={styles.labelWrapper}>
            <View style={styles.labelText}>
              <Text style={styles.text}>{identityCard}</Text>
            </View>
            {customerDetail.identity ? (
              <Text style={styles.text}>{customerDetail.identity}</Text>
            ) : (
          ...
          <View style={styles.labelWrapper}>
            ...
            {customerDetail.education ? (
              <Text style={styles.text}>{customerDetail.education}</Text>
            ) : (
              <Text style={styles.textEmpty}>{noInformation}</Text>
            )}
          </View>
          <View style={styles.labelWrapper}>
            ...
            {customerDetail.role ? (
              <Text style={styles.text}>{customerDetail.role}</Text>
            ) : (
              <Text style={styles.textEmpty}>{noInformation}</Text>
            )}
          </View>
          <View style={styles.labelWrapper}>
            ...
            {customerDetail.subjects ? (
              <Text style={styles.text}>{customerDetail.subjects}</Text>
            ) : (
              <Text style={styles.textEmpty}>{noInformation}</Text>
            )}
          </View>
          <View style={styles.labelWrapper}>
            <View style={styles.labelText}>
              <Text style={styles.text}>{contractType}</Text>
            </View>
            {customerDetail.contract_type ? (
              <Text style={styles.text}>{customerDetail.contract_type}</Text>
            ) : (
              <Text style={styles.textEmpty}>{noInformation}</Text>
            )}
          </View>
          <View style={styles.labelWrapper}>
            ...
            {customerDetail.position ? (
              <Text style={styles.text}>{customerDetail.position}</Text>
            ) : (
              <Text style={styles.textEmpty}>{noInformation}</Text>
            )}
          </View>
          <View style={styles.labelWrapper}>
            ...
            {customerDetail.nationality ? (
              <Text style={styles.text}>{customerDetail.nationality}</Text>
            ) : (
              <Text style={styles.textEmpty}>{noInformation}</Text>
            )}
          </View>
